...
{
	// Adjust the camera's zoom level based on scroll wheel input
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// Toggle to Perspective Projection when 'P' is pressed
	...
	// Toggle to Orthographic Projection when 'O' is pressed
...
void ViewManager::PrepareSceneView()
{
	...
	if (bOrthographicProjection)
	{
		...
		g_pCamera->Position = glm::vec3(0.0f, 0.0f, 10.0f); // Camera looking straight at the object
